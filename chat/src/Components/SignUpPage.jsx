  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center relative">
      ...
      <div className="absolute top-[250px] left-[155px] text-center">
        <h1 className="text-8xl font-bold text-black">SIGN UP</h1>
        <p className="text-6xl font-medium text-[#008D9C]">TO BOTCHAT</p>
      </div>

      <div className="absolute w-[450px] right-[155px] top-[60px] bg-white p-6 rounded-lg">
        ...
        <p className="text-sm text-right text-gray-600 mt-4">
          <Link to="/" className="text-[#008D9C] hover:underline">
            Login
          </Link>
        </p>
